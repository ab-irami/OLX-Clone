...
class SellerSubCatListScreen extends StatelessWidget {
  const SellerSubCatListScreen({Key? key}) : super(key: key);

  static const String id = 'seller_sub_cat_list_screen';
